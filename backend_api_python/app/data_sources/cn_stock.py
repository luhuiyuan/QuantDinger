"""A-share compatibility surface backed exclusively by unified data routing."""
...
class CNStockDataSource(BaseDataSource):
    ...
    def get_kline(
        ...
        result = get_routed_external_data_gateway().execute(
            ...
            {"market": "CNStock", "symbol": symbol, "limit": limit, "before_time": before_time},
            constraints={"market": "CNStock", "timeframe": timeframe, "adjustment": "qfq"},
        )
